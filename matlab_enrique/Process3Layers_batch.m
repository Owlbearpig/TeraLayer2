...
for k=0:100
    s=dlmread(['Kopf_1x_0' num2str(k,'%03.f')], ',', 1, 0);
...
text(25,110,['d1 = ' num2str(mds(1)*1e6) ' \pm ' num2str(sds(1)*1e6) '{\mu}m'],'color',c_azul,'HorizontalAlignment','center');
text(50,550,['d2 = ' num2str(mds(2)*1e6) ' \pm ' num2str(sds(2)*1e6) '{\mu}m'],'color',c_rojo,'HorizontalAlignment','center');
text(75,110,['d3 = ' num2str(mds(3)*1e6) ' \pm ' num2str(sds(3)*1e6) '{\mu}m'],'color',c_amarillo,'HorizontalAlignment','center');
