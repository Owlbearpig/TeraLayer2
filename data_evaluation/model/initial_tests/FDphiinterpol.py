...
if os.name == 'posix':
    bkg_file = Path(r"/matlab_enrique/Data/BG_1000.csv")
    ref_file = Path(r"/matlab_enrique/Data/ref_1000x.csv")
    sam_file = Path(r"/matlab_enrique/Data/Kopf_1x/Kopf_1x_0011")
else:
