...
class SamplesEnum(Enum):
    ...
    # 2 layer
    bwCeramicWhiteUp = Sample([0.500, 0.140], [(2.879 - 0.001j, 2.966 - 0.023j), (2.73 - 0.001j, 2.75 - 0.023j)])
    bwCeramicBlackUp = Sample([0.140, 0.500], [(2.73 - 0.001j, 2.75 - 0.023j), (2.879 - 0.001j, 2.966 - 0.023j)])
