...
class SamplesEnum(Enum):
    ...
    # 2 layer
    bwCeramicWhiteUp = Sample([0.500, 0.140], [(2.911 - 0.001j, 2.950 - 0.059j), (2.685 - 0.001j, 2.722 - 0.0636j)])
    bwCeramicBlackUp = Sample([0.140, 0.500], [(2.685 - 0.001j, 2.722 - 0.0636j), (2.911 - 0.001j, 2.950 - 0.059j)])
