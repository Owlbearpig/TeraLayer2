...
class SamplesEnum(Enum):
    ...
    # 3 layer
    ampelMannRight = Sample([0.045, 0.660, 0.076], [(1.504, 1.54), (2.78 - 0.000j, 2.85 - 0.025j),
                                                    (1.504, 1.54)])  # WORKS
    ampelMannLeft = Sample([0.073, 0.660, 0.043], [(1.527 - 0.000j, 1.532 - 0.015j),
                                                   (2.80 - 0.000j, 2.82 - 0.015j),
                                                   (1.527 - 0.000j, 1.532 - 0.015j)])
